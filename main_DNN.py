...
nbrAPsPerDim = np.int_(np.sqrt(L))
...
interAPDistance = np.int_(squareLength/nbrAPsPerDim)
    ...
    for l in range(0, L):
        for t in range(0, tau_p):
            ...
            for k in  np.argwhere(t==pilotIndex):
                ...
                #print("np.int_(k):", np.int_(k))
                #print("np.int_(k).shape:", np.int_(k).shape)
                #print("CorrR[:,:,np.int_(k),l]:", CorrR[:,:,np.int_(k),l])
                #print("CorrR[:,:,np.int_(k),l].shape:", CorrR[:,:,np.int_(k),l].shape)
                #print("np.linalg.inv(PsiInv):", np.linalg.inv(PsiInv))
                #print("PsiInv.shape:", PsiInv.shape)
                #print("np.linalg.inv(PsiInv).shape:", np.linalg.inv(PsiInv).shape)
                RPsi = np.matmul(CorrR[:,:,np.int_(k),l].reshape([4, 4]),np.linalg.inv(PsiInv))
                
                #print("RPsi.shape:", RPsi.shape)
                #print("yp.shape:", yp.shape)
                a = np.zeros([4, 100])
                a = np.sqrt(p*tau_p)*np.matmul( RPsi, yp ).reshape([4, 100, 1])
                Hhat[:,:,np.int_(k),l]= a
                Hhat_MMSE_MeanSquare[np.int_(k),l] =  (p * tau_p/ M) * np.real(np.trace (  np.matmul( RPsi, CorrR[:,:,np.int_(k),l] ) )  )
...
# plt.savefig('1st_Fig.7(Sum-SE).png')
...
# plt.xlabel('SE per UE [bit/s/Hz]', fontsize=34)
# plt.ylabel('CDF', fontsize=34)
# plt.savefig('3rd_Fig.8(Sum-SE).png')
...
# plt.xlabel('SE per UE [bit/s/Hz]', fontsize=34)
# plt.ylabel('CDF', fontsize=34)
# plt.savefig('5th_Fig.5(Sum-SE).png')
...
# plt.xlabel('SE per UE [bit/s/Hz]', fontsize=34)
# plt.ylabel('CDF', fontsize=34)
# plt.savefig('7th_Fig.6(Sum-SE).png')
...
# plt.xlabel('SE per UE [bit/s/Hz]', fontsize=34)
# plt.ylabel('CDF', fontsize=34)
# plt.savefig('10th_Fig.4(RZF).png')
...
# plt.ylabel('CDF', fontsize=34)
# plt.savefig('11th_Fig.11(MR).png')
...
# plt.xlabel('Total SE [bit/s/Hz]', fontsize=34)
# plt.ylabel('CDF', fontsize=34)
# plt.savefig('13th_weizhi.png')

fig = plt.figure(figsize=(16,12))

plt.plot(sorted_SE_MR_Equal,  Yvals, color='#000000ff', label='Equal power', linewidth=4)

plt.plot(sorted_SE_MR_WMMSE_ADMM, Yvals, color='r',  marker=3, markevery=1000, label='sumSE ADMM', linewidth=4,markersize=15)
...
plt.plot(sorted_SE_RZF_WMMSE_ADMM, Yvals, color='r',  marker=3, markevery=1000, label='sumSE ADMM', linewidth=4,markersize=15)
...
plt.plot(sorted_SE_MR_WMMSE_ADMM, Yvals, color='b',  marker=3, markevery=1000, label='sumSE ADMM', linewidth=4,markersize=15)
...
plt.plot(sorted_SE_RZF_WMMSE_ADMM, Yvals, color='b',  marker=3, markevery=1000, label='sumSE ADMM', linewidth=4,markersize=15) 
...
plt.plot(sum_SE_MR_WMMSE_ADMM, Yvals_sum, color='r',  marker=3, markevery=50, label='sumSE ADMM', linewidth=4,markersize=15) 
...
plt.plot(sum_SE_RZF_WMMSE_ADMM, Yvals_sum, color='r',  marker=3, markevery=50, label='sumSE ADMM', linewidth=4,markersize=15) 
